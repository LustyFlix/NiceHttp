package com.lustyflix.nicehttp.example
...
import com.lustyflix.nicehttp.Requests
import com.lustyflix.nicehttp.ResponseParser
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            val json =
                requests.get("https://api.github.com/repos/lustyflix/nicehttp")
                    .parsed<GithubJson>()
